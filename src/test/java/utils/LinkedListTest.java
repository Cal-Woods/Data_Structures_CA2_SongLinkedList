...
public class LinkedListTest {
    ...
    /**
     * Testing valid input with get method, when getting from the start of the list, of class LinkedList.
     */
    @Test
    public void testGet_ValidInput_StartOfList() {
        LinkedList instance = new LinkedList();
        instance.add(new Song("Title 0", "Artist 1"));
        instance.add(new Song("Title 1", "Artist 1"));
        instance.add(new Song("Title 2", "Artist 1"));

        Song expResult = new Song("Title 0", "Artist 1");
        Song result = instance.get(0);
        assertEquals(expResult, result);
    }
    ...
    /**
     * Test of tail method with a list containing more than one element, of class LinkedList.
     */
    @Test
    public void testTail_PopulatedList() {
        LinkedList instance = new LinkedList();
        Song lastSong = new Song("Temp Title", "Temp Artist1");
        instance.add(new Song("Temp title0", "Temp Artist1"));
        instance.add(new Song("Temp title1", "Temp Artist1"));
        instance.add(lastSong);

        Song expResult = lastSong;
        Song result = instance.tail();
        assertEquals(expResult, result, "Incorrect tail element returned");
    }

    /**
     * Test of tail method with a list containing only one element, of class LinkedList.
     */
    @Test
    public void testTail_ListOfOneElement() {
        LinkedList instance = new LinkedList();
        Song song = new Song("Temp Title", "Temp Artist1");
        instance.add(song);
    ...
    /**
     * Test of tail method with an empty list, of class LinkedList.
     */
    @Test
    public void testTail_EmptyList() {
        LinkedList instance = new LinkedList();

        assertThrows(NoSuchElementException.class, () -> {
            instance.tail();
        }, "No/Incorrect exception thrown when tail() called on empty list.");
    }
}
